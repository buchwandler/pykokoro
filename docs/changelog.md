...
- Fixed SSMD emphasis none handling and deduplicated warnings by source segment

### Documentation

- Documented SSMD emphasis modes, diagnostics, approximation, and migration guidance
