#!/usr/bin/env python3
"""Generate German Gold-versus-Crane speech with the Anna model."""
...
def main() -> None:
    """Generate the German Gold-versus-Crane comparison with Anna."""
    ...
    print("  acoustic model: de-anna (Anna)")
    print("  voice: df_anna")
