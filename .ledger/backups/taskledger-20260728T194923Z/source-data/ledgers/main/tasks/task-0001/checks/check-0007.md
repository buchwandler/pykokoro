...
timestamp: "2026-07-26T10:40:09Z"
command:
  python -m pytest -q tests/test_downloads.py tests/test_cache.py
  tests/test_g2p_adapter_spacy_model.py tests/test_g2p_overrides.py
argv:
  - python
  - -m
  - pytest
...
summary:
  ...
  tests/test_g2p_adapter_spacy_model.py tests/test_g2p_overrides.py (exit 1)
stdout_ref: null
stderr_ref: null
combined_ref: null
---
